...
public class BankingLicenceTest extends TestBase {
	AdminHomePage h;
	...
	@Test(description = "Switch to Revolut URL")
	...
	@Test(description = "Login with credentials", dataProvider = "getRevoltadminloginData", dependsOnMethods = "Home")
	...
	public void searchContent() throws IOException, AWTException, InterruptedException {
		...
		adminLoginObj.clicksearchTopic();
		adminLoginObj.EntersearchOption(searchvalue);
		adminLoginObj.clickDropdownLink();
		Thread.sleep(2000);
		adminLoginObj.clickWeGotaBankingLicenceLink();
		Thread.sleep(5000);
		String actualTitle = driver.getTitle();
		Thread.sleep(3000);

		if (actualTitle == "We didn't get a banking licence") {
			System.out.print("Licence is Not Verified");
		} else {
			System.out.print("Licence is Verified");
		}
